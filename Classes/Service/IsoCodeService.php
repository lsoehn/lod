...
/*
 * This service shipped with the TYPO3 core but was explictly not part of the
 * TYPO3 Core API. Due to being removed tom the T3 core with version 12.4, we
 * duplicate it here for our purposes.
 */
...
class IsoCodeService
{
    ...
    public function renderIsoCodeSelectDropdown(array $conf = [])
    {
        ...
        foreach ($isoCodes as $isoCode) {
            $languages[$isoCode] = $languageService->sL("LLL:EXT:core/Resources/Private/Language/Iso/languages.xlf:$isoCode");
        }
